...
Shader "Main"
{
    ...
    SubShader
    {
        ...
        void surf(Input i, inout SurfaceOutputStandard o)
        {
            ...
            float lerpResult57 = lerp(tex2D(_Pattern, (((ase_worldPos + temp_output_159_0)).xy * _PatternScale)).r,
                                                tex2D(_Pattern,
                                  (((ase_worldPos + temp_output_159_0)).xz * _PatternScale)).r,
                                                abs(ase_vertexNormal.y));
            float lerpResult60 = lerp(lerpResult57,
                           tex2D(_Pattern, (((ase_worldPos + temp_output_159_0)).yz * _PatternScale)).r,
                           abs(ase_vertexNormal.x));

...
Shader "Main"
{
    Properties
    {
        ...
        [Toggle]_UsePattern("Use Pattern", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            ) : SV_Target
            {
                ...
                float3 hsvTorgb6_g3 = HSVToRGB(float3((hsvTorgb2_g3.x * break8_g3.x), (hsvTorgb2_g3.y * break8_g3.y),
                      (hsvTorgb2_g3.z * break8_g3.z)));
                ...
                float lerpResult57 = lerp(tex2D(_Pattern, (((WorldPosition + temp_output_159_0)).xy * _PatternScale)).r,
                                     tex2D(_Pattern, (((WorldPosition + temp_output_159_0)).xz * _PatternScale)).r,
                                     abs(IN.ase_normal.y));
                float lerpResult60 = lerp(lerpResult57,
        tex2D(_Pattern, (((WorldPosition + temp_output_159_0)).yz * _PatternScale)).r,
        abs(IN.ase_normal.x));
                float3 temp_cast_4 = (lerpResult60).xxx;
                float3 blendOpSrc103 = temp_cast_4;
                float3 blendOpDest103 = temp_output_43_0;
                float3 lerpBlendMode103 = lerp(blendOpDest103,
                            2.0f * blendOpDest103 * blendOpSrc103 + blendOpDest103 * blendOpDest103 * (
                                1.0f - 2.0f * blendOpSrc103), _PatternBlend);
                ...
                float3 localPerturbNormal107_g2 = PerturbNormal107_g2(surf_pos107_g2, surf_norm107_g2, height107_g2,
                    scale107_g2);
        ...
        Pass
        {
            ...
            )
            {
                ...
                float lerpResult60 = lerp(lerpResult57,
            tex2D(_Pattern,
(((WorldPosition + temp_output_159_0)).yz * _PatternScale)).r,
            abs(IN.ase_normal.x));
                float3 temp_cast_4 = (lerpResult60).xxx;
                float3 blendOpSrc103 = temp_cast_4;
                float3 blendOpDest103 = temp_output_43_0;
                float3 lerpBlendMode103 = lerp(blendOpDest103,
2.0f * blendOpDest103 * blendOpSrc103 + blendOpDest103 *
blendOpDest103 * (1.0f - 2.0f * blendOpSrc103),
_PatternBlend);
                float3 blendOpSrc170 = temp_cast_0;
                float3 blendOpDest170 = ((_UsePattern) ? ((saturate(lerpBlendMode103))) : (temp_output_43_0));
                float3 lerpBlendMode170 = lerp(blendOpDest170, (blendOpSrc170 * blendOpDest170), _Gradient);

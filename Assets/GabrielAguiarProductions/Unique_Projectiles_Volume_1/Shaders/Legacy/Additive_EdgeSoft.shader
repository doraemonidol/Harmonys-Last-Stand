    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR
            {
                ...
                float3 emissive = ((_MainTex_var.rgb * i.vertexColor.rgb * _TintColor.rgb * 2.0 * (_MainTex_var.a * i.
                                          vertexColor.a * _TintColor.a)) * saturate((sceneZ - partZ) / _EdgeSoftness) *
                    clamp(isFrontFace, _DoubleSided, 1.0));

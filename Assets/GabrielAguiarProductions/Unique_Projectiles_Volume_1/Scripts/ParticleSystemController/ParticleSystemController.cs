...
namespace GAP_ParticleSystemController
{
    ...
    public class ParticleSystemController : MonoBehaviour
    {
        ...
        public Color newMaxColor = new(0, 0, 0, 1);
        public Color newMinColor = new(0, 0, 0, 1);
        public List<GameObject> ParticleSystems = new();
        public List<bool> ActiveParticleSystems = new();

        private readonly List<ParticleSystemOriginalSettings> psOriginalSettingsList = new();
            ...
            if (ParticleSystems.Count > 0)
            {
                for (var i = 0; i < ParticleSystems.Count; i++)
                {
                    ...
                    if (ps != null)
                    {
                        ...
                        {
                            var psOriginalSettings = new ParticleSystemOriginalSettings
                            {
                        ...
                        {
                            var listOriginalSettings = new List<ParticleSystemOriginalSettings>();
                        ...
                        if (changeColor)
                        {
                            ...
                            {
                                startColor.gradient =
                                    ChangeGradientColor(startColor.gradient, newMaxColor, newMinColor);
                                main.startColor = startColor;
                            }

                            if (main.startColor.mode == ParticleSystemGradientMode.TwoGradients)
                            {
                                startColor.gradientMax =
                                    ChangeGradientColor(startColor.gradientMax, newMaxColor, newMinColor);
                                startColor.gradientMin =
                                    ChangeGradientColor(startColor.gradientMin, newMinColor, newMaxColor);
                                main.startColor = startColor;
                            }
                            ...
                            if (colorOverLifetime.enabled)
                            {
                                ...
                                {
                                    colorOverLifetimeC.gradientMax = ChangeGradientColor(colorOverLifetimeC.gradientMax,
                                        newMaxColor, newMinColor);
                                    colorOverLifetimeC.gradientMin = ChangeGradientColor(colorOverLifetimeC.gradientMin,
                                        newMinColor, newMaxColor);
                                }
        ...
        {
            var colorKeys = new GradientColorKey[oldGradient.colorKeys.Length];
            for (var j = 0; j < oldGradient.colorKeys.Length; j++)
            {
        ...
        public void FillLists()
        {
            if (ParticleSystems.Count == 0)
            {
                ...
                for (var i = 0; i < ParticleSystems.Count; i++) ActiveParticleSystems.Add(true);
            }
            else
            {
                Debug.Log(

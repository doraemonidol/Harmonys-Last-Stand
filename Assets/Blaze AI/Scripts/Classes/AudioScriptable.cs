...
namespace BlazeAISpace
{
    ...
    public class AudioScriptable : ScriptableObject
    {
        ...
        [Space(10)] [Header("Alert State Behaviour")] [Tooltip("Audios to play when patrolling in alert state.")]
        ...
        [Space(10)]
        [Header("Surprised State Behaviour")]
        [Tooltip("Audios to play on surprised state. (seeing enemy when in normal state)")]
        public AudioClip[] surprisedState;


        [Space(10)] [Header("Attack State Behaviour")] [Tooltip("Audios to play on attacking target.")]
        ...
        [Space(10)] [Header("Attack Behaviour & Cover Shooter")] [Tooltip("Audios to play when AI is chasing target.")]
        ...
        [Space(10)]
        [Header("Cover Shooter & Going To Cover")]
        [Tooltip(
            "Audios to play when AI is shooting. This isn't the firing audio of the gun. But, an audio to play while shooting, like screaming for example.")]
        ...
        [Space(10)] [Header("Distracted Behaviour")] [Tooltip("Audios to play on getting distracted.")]
        ...
        [Space(10)] [Header("Searching")] [Tooltip("Audios to play when beginning to search.")]
        ...
        [Space(10)] [Header("Hit & Death")] [Tooltip("Audios to play when hit.")]
        public AudioClip[] hit;

        [Tooltip("Audios to play on death.")] public AudioClip[] death;


        [Space(10)] [Header("Alert Tags")] [Tooltip("Audios to play when vision catches an alert tag game object.")]
        public AudioClip[] alertTags;


        [Space(10)] [Header("Fleeing")] [Tooltip("Audios to play when fleeing behaviour is active.")]
        ...
        [HideInInspector] public Dictionary<int, AudioClip[]> audios = new();
        ...
        {
            if (audios[(int)type].Length <= 0) return null;
            ...
            if (audios[(int)type][randomSound] == null) return null;
        ...
        public virtual AudioClip GetAudio(AudioType type, int index)
        {
            ...
            if (index > audios[(int)type].Length - 1) return null;

            if (audios[(int)type][index] == null) return null;
